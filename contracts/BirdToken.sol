...
contract BirdOracle {
    ...
    modifier paymentApproved(address _ethAddressToQuery) {
        require(
            ...
            "Please pay 1 BIRD to BirdOracle by using method sendPayment()"
        );
        _;
    }
    ...
    uint256 public priceToAccessOracle = 1 * 1e18; //priceToAccessOracle for 30 days is 1 BIRD
    ...
    function rewardProviders() public {
        require(birdNest > 0, "There are no providers.");
